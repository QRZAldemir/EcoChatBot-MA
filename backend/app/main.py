...
#
# MELHORIA DE ENGENHARIA: as origens permitidas vêm da variável de ambiente
# CORS_ORIGINS (mesmo nome documentado em .env.example), aceitando uma lista
# separada por vírgulas (ex: "https://app.com,https://www.app.com") - assim
# dev/homologação/produção podem liberar domínios diferentes só editando o
# .env, sem tocar em código, e sem ficar limitado a uma única origem.
CORS_ORIGINS = [
    origem.strip()
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=CORS_ORIGINS,    # Domínios permitidos para acessar a API
